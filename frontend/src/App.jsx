...
export default function App() {
  ...
  return (
    <div style={{ position: 'fixed', inset: 0, width: '100vw', height: '100vh', overflow: 'hidden', background: '#020617', fontFamily: 'Segoe UI, system-ui, sans-serif', color: '#f8fafc' }}>
      
      {/* Absolute Fullscreen Interactive Map Canvas */}
      <MapContainer
        center={[20.0, 79.0]}
        zoom={5}
        zoomControl={true}
      ...
      <header style={{
        ...
        background: 'rgba(9, 13, 22, 0.95)', backdropFilter: 'blur(10px)',
      ...
      {!hideHud && (
        <aside style={{
          ...
          boxShadow: '0 10px 30px rgba(0,0,0,0.85)', maxHeight: 'calc(100vh - 80px)', overflowY: 'auto'
        }}>
